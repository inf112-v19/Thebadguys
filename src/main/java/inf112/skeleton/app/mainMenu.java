...
public class mainMenu {
    ...
    public mainMenu(SpriteBatch batch, RoboRallyDemo game){
        mainRunning = true;
        this.batch=batch;
        this.game = game;
        font = new BitmapFont();
    ...
    public void startMenu(){
        ...
        clientButton = new Button(150, 500, "clientButton", clientSprite, game);
        ...
        serverButton = new Button(400, 500, "serverButton", serverSprite, game);
        ...
        startButton = new Button(650, 500, "startButton", startSprite, game);
    }
